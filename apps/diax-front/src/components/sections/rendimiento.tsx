...
const Rendimiento: React.FC<RendimientoProps> = ({ data }) => {
  ...
  return (
    <div className={`${styles['cube-container']} ${styles.rendimiento}`}>
      ...
      >
        <ul
          className={`${styles.legend} ${styles.ul} ${styles['legend-rendimiento']}`}
        ></ul>

        <div
          className={`${styles['line-container']} ${styles['line-rendimiento-container']}`}
        >
          <div className={`${styles['line-rendimiento']}`}>
            <TimeSeriesLineChart
              labelY="inyecciones"
              series={data?.MultiLine}
            />
        ...
        >
          <div
            className={`${styles['pie-container']} ${styles['margin-gd']} ${styles['pie-rendimiento-container']}`}
          >
